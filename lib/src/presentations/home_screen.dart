                    ...
                    const Row(
                      children: [
                        Padding(
                          ...
                          child: CircleAvatar(radius: 20, backgroundImage: AssetImage("assets/images/blank-profile.png")),
                        ),
                        Text("Văn A"),
                        Spacer(),
                        Padding(
        ...
        Padding(
          ...
          child: Column(
            children: [
              Stack(
                children: [
                  CircleAvatar(radius: 32, backgroundImage: AssetImage("assets/images/blank-profile.png")),
                  Positioned(
                    bottom: 1,
                    right: 1,
                    child: CircleAvatar(
